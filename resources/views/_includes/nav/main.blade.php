...
<div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="{{route('dispatch')}}" class="list-group-item list-group-item-action bg-light">Dispatch</a>
        <a href="{{route('resource')}}" class="list-group-item list-group-item-action bg-light">Resources</a>
